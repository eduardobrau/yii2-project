    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body"> 
        <div class="widget-tempo"
          <!-- Widget Previs&atilde;o de Tempo CPTEC/INPE --><iframe allowtransparency="true" marginwidth="0" marginheight="0" hspace="0" vspace="0" frameborder="0" scrolling="no" src="http://www.cptec.inpe.br/widget/widget.php?p=<?=$anuncios[0]['bairro']['cidade']['tempo_id']?>&w=h&c=909090&f=ffffff" height="200px" width="215px"></iframe><noscript>Previs&atilde;o de <a href="http://www.cptec.inpe.br/cidades/tempo/<?=$anuncios[0]['bairro']['cidade']['tempo_id']?>"><?=$anuncios[0]['bairro']['cidade']['cidade']?></a> oferecido por <a href="http://www.cptec.inpe.br">CPTEC/INPE</a></noscript><!-- Widget Previs&atilde;o de Tempo CPTEC/INPE -->
        </div>
      </div>
    </div>  
